...
const RequestPage = () => {
  return (
    <div className="h-[60%] px-[12vw] py-[8vh] bg-[#f1f5f9]">
      <div className="flex flex-col items-center justify-between ">
        <div className="relative">
          <svg className="absolute left-[99%] w-16 h-16 hidden md:flex text-white fill-[#CBD5E1]">
          ...
          <h1 className="py-4 font-[PlayfairDisplay] font-bold text-black text-[48px] text-center leading-tight">
