  ...
  return (
    <div className="h-[20%] px-[12vw]">
      <div className="grid grid-cols-1 md:grid-cols-[2fr,1fr,1fr,1fr,1fr]">
        ...
        <div>
          <h1 className="font-bold mt-8 mb-6">How it works</h1>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
            Overview
          </p>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
            Pricing
        ...
        <div>
          <h1 className="font-bold mt-8 mb-6">Resources</h1>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
            Customer Stories
          </p>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
        ...
        <div>
          <h1 className="font-bold mt-8 mb-6">Products</h1>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
            Corporate Partners
          </p>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
        ...
        <div>
          <h1 className="font-bold mt-8 mb-6">Company</h1>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
            About Us
          </p>
          <p className="text-[#64748b] hover:text-[#2472eb] hover:cursor-pointer mb-2">
