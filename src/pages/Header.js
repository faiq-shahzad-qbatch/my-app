...
const Header = () => {
  ...
  return (
    <nav className="bg-[#111d2d] py-4">
      <div className="flex flex-col lg:flex-row lg:items-center justify-evenly lg:justify-between space-y-5 lg:space-y-0">
        <div className="flex lg:hidden flex-row justify-between">
          <svg
            className="w-8 h-8 fill-[#2472eb]"
        ...
        <ul
          ...
          } flex-col lg:flex-row items-start lg:items-center space-x-0 lg:space-x-5 space-y-5 lg:space-y-0`}
        >
          <svg
            className={`${
          ...
          <li>
            <select className="bg-transparent text-[#96a3b9] hover:text-[#2472eb] px-3 py-2 text-md">
