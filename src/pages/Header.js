    ...
    <header className="bg-[#111d2d] py-4">
      <div className="flex flex-col justify-evenly space-y-5 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
        ...
        <ul
          ...
          } flex-col items-start space-x-0 space-y-5 lg:flex-row lg:items-center lg:space-x-5 lg:space-y-0`}
        >
          <svg
            className={`${
          ...
          <li>
            <a
              href="/"
              className="text-md px-3 py-2 text-[#96a3b9] hover:text-[#2472eb]"
            >
              Pricing
            </a>
          </li>
          ...
          <li>
            <select className="text-md bg-transparent px-3 py-2 text-[#96a3b9] hover:text-[#2472eb]">
        ...
        >
          ...
          <li className="group flex flex-row items-center justify-between">
            <a
              href="/"
              className="px-3 text-lg text-[#cbd5e1] hover:text-[#ffffff]"
            >
              Request Demo{" "}
              <FontAwesomeIcon
                icon={faArrowRight}
